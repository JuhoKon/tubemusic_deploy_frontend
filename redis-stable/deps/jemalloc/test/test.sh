...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/juho/development/tubemusic_deploy_frontend/redis-stable/deps/jemalloc/ /home/juho/development/tubemusic_deploy_frontend/redis-stable/deps/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/juho/development/tubemusic_deploy_frontend/redis-stable/deps/jemalloc/ /home/juho/development/tubemusic_deploy_frontend/redis-stable/deps/jemalloc/
